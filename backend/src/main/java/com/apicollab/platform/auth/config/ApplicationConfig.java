package com.apicollab.platform.auth.config;
...
import com.apicollab.platform.auth.service.JwtService;
...
public class ApplicationConfig {
    ...
    private final JwtService jwtService; // Inject JwtService instead of Filter
